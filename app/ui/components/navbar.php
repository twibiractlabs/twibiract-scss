<nav class="navbar lg:navbar-expand backdrop-blur shadow-sm shadow-dark p-3">
    <div class="container-fluid">
        <a class="navbar-brand flex items-center" href="index.php">
            <img src="../svg/twibiract.v1.svg" class="img-fluid" width="36px" height="36px">
            <div class="h4 mb-0">twibiract</div>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto mb-0 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link px-4" href="guide.php">
                        Guide
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link px-4" href="themes.php">
                        Thèmes
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link px-4" href="exemples.php">
                        Exemples
                    </a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link px-4" href="extrait.php">
                        Extraits
                    </a>
                </li>

                <div class="none lg:flex items-center">
                                    
                    <li class="nav-item">
                        <a class="nav-link brd-l" href="https://github.com/twibiractlabs" target="_blank">
                    ...
                    <li class="nav-item">
                        <a class="nav-link brd-r" href="https://x.com/N95524" target="_blank">
